  ...
  return (
    <div>
      <div className=" sm:w-[300px] md:h-fit w-[100vw] bg-white border-2 rounded-2xl text-center mt-8">
        ...
        <a href="https://github.com" target="_blank" className="hover:text-gray-700 text-black px-2 transition-colors">
          ...
          <a href="https://linkedin.com" target="_blank" className="hover:text-gray-700 text-black px-2 transition-colors my-0.5">
